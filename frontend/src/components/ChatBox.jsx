                  ...
                  {sending ? (
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <svg className="w-5 h-5 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <line x1="12" y1="21.6" x2="12" y2="2.4" stroke="currentColor" strokeWidth="2.0" strokeLinecap="butt"/>
                        <line x1="5.4" y1="10.6" x2="12.6" y2="3.4" stroke="currentColor" strokeWidth="2.0" strokeLinecap="butt"/>
                        <line x1="18.6" y1="10.6" x2="11.4" y2="3.4" stroke="currentColor" strokeWidth="2.0" strokeLinecap="butt"/>
